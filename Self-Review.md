...
- 2.2 Развитие FreeIPA:
	- 2.2.1 Настроить интеграцию я базой 1С/Slack/HR box для автоматического отключения учеток сотрудников - пока ждем перенос базы 1С в наше облако, хочу закрыть эту задачку к следующему ревью, но перенос базы 1С не зависит от нас, увы задачу не сделал;
...
- 4.6 Статические и динамические анализаторы кода
