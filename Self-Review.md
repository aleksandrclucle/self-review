...
- 2.2.5 Матрица доступов\
	Пока что отказались от полноценной матрицы доступов и решили для экономии ресурсов сделать "примитивную" матрицу доступов, которая наглядно показывает стандартные права для сотрудников разных должностей, эта табличка используется в основе скрипта для автоматизации выдачи доступа в FreeIPA, что сейчас пилится совместно с Ильей Зверевым.
