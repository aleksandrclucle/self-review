...
- 2.1.2 Развитие FreeIPA:
	...
	- Настроили больше интеграций авторизации через LDAP FreeIPA, планировали 3, а  настроил для 7, добавилась интеграция для Sctructurizer, Grafana, PfSense, PostgreSQL (only dev, жду новый кластер от Макса Копченова для prod), Wazuh, HashiCorp Vault, Sonatype Nexus. 
